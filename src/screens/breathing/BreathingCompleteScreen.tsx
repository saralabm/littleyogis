...
const styles = StyleSheet.create({
  ...
  container: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: spacing.screenPaddingH, gap: 16 },
  emoji: { fontSize: 64 },
  ...
  statsCard: { backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: spacing.cardRadius, paddingVertical: 20, paddingHorizontal: 32, alignItems: 'center', gap: 8 },
  statsText: { fontSize: 18, fontWeight: '700', color: '#FFF176' },
  statsSubtext: { fontSize: 16, color: 'rgba(240,240,255,0.7)' },
  homeBtn: { backgroundColor: colors.primary.sunshine, borderRadius: spacing.buttonRadius, paddingVertical: 16, paddingHorizontal: 40 },
  homeBtnText: { fontSize: 18, fontWeight: '700', color: colors.text.primary },
